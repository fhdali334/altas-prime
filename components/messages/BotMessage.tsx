...
import { formatMessageContent } from "@/lib/messageFormatter"
import { extractDownloadLinks, handleDownload } from "@/lib/linkProcessor"
...
export default function BotMessage({ message }: BotMessageProps) {
  ...
  const { cleanContent, downloadLinks } = extractDownloadLinks(message.content)
